      ...
      <div class="row-fluid">
        ...
        <div class="span10" float="right">
          ...
          <div class="hero-unit" height="500px">
            If you publish results obtained by using this system, please cite corresponding publication(s) from the following:</br></br>
            <h11>Publications</h11>
            <hr width=100% size=4 color="blue">
            <p style="font-size: 15px; line-height: 20px;">1. Y. Xiang, K. Lu, S. L. James, T. B. Borlawsky, K. Huang, P.R.O. Payne,
              &quot;<a href="http://www.sciencedirect.com/science/article/pii/S1532046411002000" target="_blank">k-neighborhood Decentralization: A Comprehensive Solution to Index the UMLS for Large Scale Knowledge Discovery</a>&quot;, 
              Journal of Biomedical Informatics. 2012, Vol 45, Issue 2, pp 323-336.</p>
              <p style="font-size: 15px; line-height: 20px;">2. Y. Xiang, K. Lu, S. L. James, T. B. Borlawsky, K. Huang, P.R.O. Payne, 
                &quot;<a href="http://proceedings.amia.org/2354bh/" target="_blank">Indexing the UMLS for Large Scale Knowledge Discovery in Biomedical Applications</a>&quot; (Poster Abstract), 
                2012 AMIA Summit on Translational Bioinformatics. 184.</p>	
          </div>
