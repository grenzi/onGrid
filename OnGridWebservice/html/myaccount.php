      ...
      <div class="row-fluid">
        ...
        <div class="span10" float="right">
          ...
          <div class="hero-unit" height="500px">
            <h11>What do you want to do?</h11>
            <hr width=100% size=4 color="blue">
            <span class="badge badge-success">Upload&nbsp</span><a href="upload.php">&nbsp&nbsp&nbsp&nbspSubmit new job</a><br>
		        <span class="badge badge-warning">History&nbsp</span><a href="history.php">&nbsp&nbsp&nbsp&nbspTrack and manage previous jobs</a><br>
		        <span class="badge badge-info">Account</span><a href="update.php">&nbsp&nbsp&nbspManage your information</a>
          </div>
