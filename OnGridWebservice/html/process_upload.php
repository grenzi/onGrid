...
else if (!(isset($_POST['process-button']) || !(is_uploaded_file($_FILES['row_file']['tmp_name'])) || !(is_uploaded_file($_FILES['col_file']['tmp_name'])))) {
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
          ...
          <div class="bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav">
              ...
              <li><a href="discovery.php">Start Discovery</a></li>
		          <li><a href="registernow.php">Register</a></li>
        ...
        <div class="span10" float="right">
          ...
          <div class="hero-unit" height="500px">
            ...
            <hr width=100% size=4 color=#357EC7 style="filter:alpha(opacity=100,finishopacity=0,style=2)">
       			<br /><br/>
            <?php include 'process_upload_files.php'; ?>
          </div>
        ...
        <script src='./assets/js/function3.js'></script>
  </body>
</html>
